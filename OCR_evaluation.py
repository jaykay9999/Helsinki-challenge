...
def evaluateImage(imageFile, trueTextFile):
    ...
    # run OCR
    options = r'--oem 1 --psm 6 -c load_system_dawg=false -c load_freq_dawg=false  -c textord_old_xheight=0  -c textord_min_xheight=100 -c '               r'preserve_interword_spaces=0'
